...
def main():
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        plot_feature_label_prediction(predictions_callback.feature_image[epoch], predictions_callback.label_image[epoch],  predictions_callback.prediction_image[epoch],
